import type { AlphaTexAstNodeLocation } from "./AlphaTexAst";
import type { AlphaTexParseMode } from "./AlphaTexParser";
import type { FlatSyncPoint } from "./../../model/Automation";
import type { SustainPedalMarker } from "./../../model/Bar";
import type { Beat } from "./../../model/Beat";
import type { DynamicValue } from "./../../model/DynamicValue";
import type { Lyrics } from "./../../model/Lyrics";
 ...
 * @public
 */
export declare enum AlphaTexDiagnosticsSeverity {
    Hint = 0,
    Warning = 1,
    Error = 2
}
 ...
 * @public
 */
export declare enum AlphaTexDiagnosticCode {
    /**
 ...
 * @public
 */
export declare class AlphaTexDiagnosticBag implements Iterable<AlphaTexDiagnostic> {
    private _hasErrors;
 ...
 * @public
 */
export declare enum AlphaTexAccidentalMode {
    Auto = 0,
    Explicit = 1
}
/**
 * @public
 */
export declare enum AlphaTexVoiceMode {
    StaffWise = 0,
    BarWise = 1
}
/**
 ...
 * @public
 */
export declare enum AlphaTexStaffNoteKind {
    Pitched = 0,
    Fretted = 1,
    Articulation = 2
}
 ...
 * @public
 */
export declare enum ArgumentListParseTypesMode {
    /**
