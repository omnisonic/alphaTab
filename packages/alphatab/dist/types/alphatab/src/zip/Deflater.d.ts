...
export declare class Deflater {
    private static readonly _isFlushing;
    static readonly isFinishing: number;
    private static readonly _busyState;
    private static readonly _flushingState;
    private static readonly _finishingState;
    private static readonly _finishedState;
    private _state;
    private _pending;
    private _engine;
    get inputCrc(): number;
