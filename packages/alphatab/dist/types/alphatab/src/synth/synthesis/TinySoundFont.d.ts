...
import { type Hydra } from "./../soundfont/Hydra";
import { OutputMode } from "./OutputMode";
import { Preset } from "./Preset";
import type { SynthEvent } from "./SynthEvent";
 ...
 * @internal
 */
export declare class TinySoundFont implements IAudioSampleSynthesizer {
    private _midiEventQueue;
    private _mutedChannels;
    private _soloChannels;
    private _isAnySolo;
    private _transpositionPitches;
    private _liveTranspositionPitches;
    currentTempo: number;
    ...
    private _channelInit;
    /**
     * Returns the preset index from a bank and preset number, or -1 if it does not exist in the loaded SoundFont
     */
    private _getPresetIndex;
    /**
     ...
     */
    channelMidiControl(channel: number, controller: ControllerType, controlValue: number): void;
    /**
    ...
    private static _setContainsRange;
