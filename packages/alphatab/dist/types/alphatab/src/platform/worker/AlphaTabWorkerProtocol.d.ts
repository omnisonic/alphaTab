...
import type { FontSizeDefinition } from "./../_barrel";
import type { RenderHints } from "./../../rendering/IScoreRenderer";
...
import type { AudioExportChunk, AudioExportOptions } from "./../../synth/IAudioExporter";
...
export type IAlphaTabWorkerMessage = {
    ...
    boundsLookup: Map<string, unknown> | null;
} | {
    cmd: 'alphaTab.error';
    error: Error;
};
...
export type IAlphaSynthWorkerMessage = {
    ...
    exporterId: number;
    chunk: AudioExportChunk | undefined;
} | {
